 ...
 *        0.0.1      Hui Lou    2015/12/9    Create and initialize
 *
 * ====================================================================
 */
...
#define I2S_TX_Channel0_ENABLE  0x01
#define I2S_RX_Channel0_ENABLE  0x00
...
/*
* Name:         BSP_I2SInit
* Description:  Initializes the i2s peripheral according to the specified.
* 
* Parameter:    None
*
* Return:       None
...
/*
* Name:         BSP_I2SStart
* Description:  Enable i2s interface.
* 
* Parameter:    channel: I2S_RX_Channel0_ENABLE  or I2S_TX_Channel0_ENABLE
*
* Return:       None
* 
* Note:         None
...
/*
* Name:         BSP_I2SHalt
* Description:  STOP i2s interface.
* 
* Parameter:    None
*
* Return:       None
...
/*
* Name:         BSP_I2SDeinit
* Description:  Recovery i2s interface.
* 
* Parameter:    None
*
* Return:       None
...
/*
* Name:         BSP_I2SMute
* Description:  Mute i2s interface.
* 
* Parameter:    None
*
* Return:       None
...
/*
* Name:         BSP_I2SSound
* Description:  Sound i2s interface.
* 
* Parameter:    None
*
* Return:       None
...
/*
* Name:         BSP_I2SIntISR
* Description:  I2S interface IRQ Function.
* 
* Parameter:    None
*
* Return:       None
